"""From https://github.com/DanielMengLiu/AudioVisualLip/blob/main/models/VideoResNet_new.py"""
import math
import torch
...
class ResNetBackBone(nn.Module):
    def __init__(self, block, layers, num_classes=1000, relu_type='relu', gamma_zero=False, avg_pool_downsample=False,
        ...
        self.layer4 = self._make_layer(block, backend_out, layers[3], stride=2)  # 256
